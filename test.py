...
parser.add_argument('-data', type=str, default='data/myTestData/volume-', help='test images')
...
def predict(args):
    ...
    for id in range(0,28):
        ...
        # added by me: Vijay Kumar
        min_Count = min(Segmask.shape[2],liver_labels.shape[2])
        #print(min_Count)
        Segmask = Segmask[:,:,0:min_Count-1] * liver_labels[:,:,0:min_Count-1]
        liver_res = liver_res[:,:,0:min_Count-1]
